      ...
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl shadow-rose-600/40 ring-2 ring-purple-600 lg:max-w-xl">
        ...
        <form className="mt-6">
          ...
          <div className="mb-2">
            ...
            <input
              type="password"
              className="block w-full px-4 py-2 mt-2 text-purple-700 bg-white border border-[#E9EEF7] rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
